    ...
    <div id="carouselExampleIndicators" data-aos="fade-up" class="carousel slide" style="margin-bottom: 45px;">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div style="width: 850px; height: 600px; background-image: url(../assets/img/divide/냄비.webp); background-position: 50% 50%; background-repeat: no-repeat;background-size: cover;"">
          </div>
        </div>
        <div class="carousel-item">
          <div style="width: 850px; height: 600px; background-image: url(../assets/img/divide/스팸.webp); background-position: 50% 50%; background-repeat: no-repeat;background-size: cover;"">
          </div>
        </div>
        <div class="carousel-item">
          <div style="width: 850px; height: 600px; background-image: url(../assets/img/divide/옛날\ 시계.webp); background-position: 50% 50%; background-repeat: no-repeat;background-size: cover;"">
          </div>
        </div>
      </div>
