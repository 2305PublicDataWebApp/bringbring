  ...
  <section id="hero" class="d-flex align-items-center" style="width: 100%;margin: 0 auto;">
    <div style="width: 1300px;margin: 0 auto;">
      <div style="float: left;margin-top: 60px;">
        <h1>관리자 배출 관리 - 동대문구</h1>
        <div style="width: 100%;height: 30px;"></div>
        <h4 style="color: rgb(189, 245, 229);">회원들이 예약한 배출 정보를 관리할 수 있습니다.</h4>
      </div>
      <div style="display: flex;flex-direction: row;justify-content: flex-end;">
        <img src="../assets/img/admin/page-icon2.png" style="width: 250px;" alt="">
      </div>
    </div>
  </section>
  ...
  <main>
    <section>
      <div class="row">
        ...
        <div class="col-md-3">
          <button onclick="location.href='../admin/reservationManagement.html'" class="region-btn" style="width: 300px; height: 80px; border: none;">
              <h4>전체 예약조회</h4> 
          </div>
        </div>
      </div>
