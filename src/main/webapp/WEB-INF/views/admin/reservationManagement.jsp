        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>관리자 메뉴</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="../admin/emissionManagement.html">배출 관리</a></li>
            </ul>
          </li>
          <li>
  ...
  <section id="hero" class="d-flex align-items-center" style="width: 100%;margin: 0 auto;">
    <div style="width: 1300px;margin: 0 auto;">
      ...
      <div style="display: flex;flex-direction: row;justify-content: flex-end;">
        <img src="../assets/img/admin/page-icon3.png" style="width: 250px;" alt="">
      </div>
    </div>
  </section>
  ...
  <main>
    <section>
      <div class="row">
        ...
        <div class="col-md-3">
          <button onclick="location.href='../admin/localReservationManagement.html'" class="region-btn" style="width: 300px; height: 80px; border: none;">
              <h4>관할 지역조회</h4> 
          </div>
        </div>
      </div>
