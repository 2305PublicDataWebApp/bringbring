...
<!--  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css"/>-->
  ...
  <script type='text/javascript' src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.min.js"></script>
  <!-- 달력 한글로 출력 js 파일-->
  <script src="../../assets/js/reservation/bootstrap-datepicker.kr.js" charset="UTF-8"></script>




  <link rel="stylesheet" href="../../assets/css/reservation/inputInfo.css">
...
<section id="hero" class="d-flex align-items-center" style="width: 100%;margin: 0 auto;">
  <div style="width: 1300px;margin: 0 auto;">
    ...
    <div style="display: flex;flex-direction: row;justify-content: flex-end;">
      <img src="../../assets/img/reservation/applicationInformation.png" style="width: 250px;" alt="">
    </div>
  </div>
      ...
      <div class="container-in">
        ...
        <div class="input-group date input-div" style="width: 520px">
          ...
          <label type="button" id="calenderClick" for="calenderControll">
            <img src="../../assets/img/reservation/calendar.png" id="calender">
          </label>
        </div>
      </div>
      <div class="container-in">
