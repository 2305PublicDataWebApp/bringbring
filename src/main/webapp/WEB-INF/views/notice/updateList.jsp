			...
			<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
				...
				<li class="nav-item" role="presentation">
					<button class="nav-link" id="pills-service-tab"
						...
						aria-selected="false" value="service" onclick="showServiceList()">서비스</button>
				</li>
				<li class="nav-item" role="presentation">
			...
			<div class="tab-pane fade show active" id="pills-update" role="tabpanel"
				...
				<div class="col-lg-12">
					<table class="table table-hover text-center">
						...
						<tbody>
							<c:forEach var="notice" items="${updateList }" varStatus="n">
		...
		<nav aria-label="Page navigation example">
			<ul class="pagination">
				<c:if test="${pInfo.startNavi != 1 }">
					<li class="page-item">
								<c:url var="preUrl" value="/notice/updateList.do">
				...
				<c:forEach begin="${pInfo.startNavi }" end="${pInfo.endNavi }"
					var="p">
					<c:url var="pageUrl" value="/notice/updateList.do">
				...
				<c:if test="${pInfo.endNavi != pInfo.naviTotalCount }">
					<li class="page-item">
								<c:url var="nextUrl" value="/notice/updateList.do">
